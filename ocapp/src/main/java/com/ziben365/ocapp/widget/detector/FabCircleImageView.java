 ...
 */
public class FabCircleImageView extends ImageView {
    ...
    public FabCircleImageView(Context context) {
        this(context,null);
    }

    public FabCircleImageView(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public FabCircleImageView(Context context, AttributeSet attrs, int defStyle) {
