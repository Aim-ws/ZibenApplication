 ...
 */
public class PRecyclerAddQuestionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PRecyclerAddQuestionAdapter(Context context, List<ProjectCard> questions) {
...
//        viewHolder.mPQName.setCompoundDrawables(d,null,null,null);
        ...
        viewHolder.mPQAnswer.setSingleLine(true);
        viewHolder.mPQAnswer.setEllipsize(TextUtils.TruncateAt.END);
    }
